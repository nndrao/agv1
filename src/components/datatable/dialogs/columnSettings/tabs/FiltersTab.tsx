...
import { Info, Settings, Filter, Calendar, Hash, Type, ToggleLeft, Search, X, Plus } from 'lucide-react';
      ...
      <div className="space-y-6 p-5">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            {recommendedFilterType && currentFilterType !== recommendedFilterType && (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="floating-filter" className="text-sm">
                Floating Filter
              </Label>
              <Switch
                id="floating-filter"
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="suppress-menu" className="text-sm">
                Hide Filter Menu
              </Label>
              <Switch
                id="suppress-menu"
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="suppress-tool-panel" className="text-sm">
                Hide in Filters Tool Panel
              </Label>
              <Switch
          ...
          {currentFilterType && currentFilterType !== 'none' && (
            <>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <h4 className="text-sm font-medium">Filter Parameters</h4>
                  <Button
                    variant="ghost"
                    size="sm"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription className="text-xs">
                Apply common filter configurations
              </CardDescription>
            </CardHeader>
...
const TextFilterParams: React.FC<{
  ...
  return (
    <>
      <div className="space-y-2">
        <Label>Default Filter Option</Label>
        <Select
...
const NumberFilterParams: React.FC<{
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        <Label htmlFor="number-parser">Custom Number Parser</Label>
        <Input
          id="number-parser"
...
const SetFilterParams: React.FC<{
  ...
  return (
    <>
      ...
      <div className="space-y-2">
        <Label htmlFor="comparator">Sort Order</Label>
        <Select
...
const AdvancedFilterParams: React.FC<{
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="suppress-and-or">Hide AND/OR Conditions</Label>
        <Switch
          id="suppress-and-or"
      ...
      <div className="space-y-2">
        <Label htmlFor="clear-button">Show Clear Button</Label>
        <Switch
          id="clear-button"
      ...
      <div className="space-y-2">
        <Label htmlFor="close-on-apply">Close on Apply</Label>
        <Switch
          id="close-on-apply"
      ...
      <div className="space-y-2">
        <Label htmlFor="max-valid-year">Max Valid Year (Date Filter)</Label>
        <Input
          id="max-valid-year"
          type="number"
          value={filterParams.maxValidYear || 2099}
          onChange={(e) => onParamChange('maxValidYear', parseInt(e.target.value))}
          disabled={disabled || filterType !== 'agDateColumnFilter'}
        />
      </div>

      <div className="space-y-2">
        <Label htmlFor="excel-mode">Excel Mode (Set Filter)</Label>
        <Select
          value={filterParams.excelMode || 'windows'}
          onValueChange={(value) => onParamChange('excelMode', value)}
          disabled={disabled || filterType !== 'agSetColumnFilter'}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        <Label htmlFor="new-rows-action">New Rows Action (Set Filter)</Label>
        <Select
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <Label htmlFor="display-key">Display Style</Label>
          <Select
