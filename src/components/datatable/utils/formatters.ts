 ...
 */
function parseStyleDirectives(section: string): React.CSSProperties {
 ...
 */
function parseColorValue(colorValue: string): string {
 ...
 */
function processFormatSection(format: string, value: unknown, params?: ValueFormatterParams): string {
