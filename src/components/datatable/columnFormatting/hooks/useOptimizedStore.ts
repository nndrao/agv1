...
export const useColumnActions = () => useColumnFormattingStore(
  state => ({
...
export const useColumnState = () => useColumnFormattingStore(
  state => ({
...
export const useApplyOperations = () => {
  const applyChanges = useColumnFormattingStore(state => state.applyChanges);
  const pendingChanges = useColumnFormattingStore(state => state.pendingChanges);
...
export const useDialogControls = () => {
  return useColumnFormattingStore(
    state => ({
      open: state.open,
